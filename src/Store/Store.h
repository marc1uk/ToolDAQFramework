...
class Store{
 ...
 public:
  ...
  void Initialise(std::stringstream inputstream); ///< Initialises Store by reading entries from an ASCII text stream. Each line is a variable and its value in key value pairs. @param inputstream The stream to read from.
